...
<div class="sidenav">
  ...
  <a href="register.php">View User</a>
...
<div class="main">
  <h1 class="mb-1" style="margin-top: 20px;margin-left: 50px;">List of Pending User</h1><br><br><br>
  ...
  <?php
	  ...
	  foreach ($result as $row)
	  {
          ...
          echo"<td><button class='btn btn-primary btn-block' onclick=approve('$cname')>Approve</button></td>";
		echo"</tr>";
	  }
	  echo"</table>";
  ?>
...
<!-- Confirmation box for approving user-->
<script type="text/javascript"> 
